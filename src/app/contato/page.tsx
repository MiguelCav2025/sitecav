...
export default function ContatoPage() {
  ...
  return (
    <div className="bg-blue-900 section-responsive">
        ...
        <div className="bg-white rounded-2xl shadow-2xl overflow-hidden">
          <div className="grid grid-cols-1 md:grid-cols-2">
            ...
            <div className="card-responsive bg-gray-50">
              <h2 className="text-subsection text-blue-900 mb-4">Informações de Contato</h2>
              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h3 className="text-card-title text-blue-900">Endereço</h3>
                    <p className="text-responsive text-gray-600">Rua Helena Jacquey, 208 - Rudge Ramos - São Bernardo do Campo - SP - 09635-060</p>
                  </div>
                </div>
                <div className="flex items-start space-x-4">
                  <Phone className="h-6 w-6 text-orange-500 mt-1 flex-shrink-0" />
                  <div>
                    <h3 className="text-card-title text-blue-900">Telefone</h3>
                    <p className="text-responsive text-gray-600">(11) 2630-7874</p>
                  </div>
                </div>
                <div className="flex items-start space-x-4">
                  <Mail className="h-6 w-6 text-orange-500 mt-1 flex-shrink-0" />
                  <div>
                    <h3 className="text-card-title text-blue-900">Email</h3>
                    <p className="text-responsive text-gray-600">centrodeaudiovisualsbc@gmail.com</p>
                  </div>
                </div>
              </div>
            ...
            <div className="card-responsive">
              <h2 className="text-subsection text-blue-900 mb-8">Envie uma Mensagem</h2>
              <form className="space-y-6" onSubmit={handleSubmit}>
                <div>
                  <label htmlFor="name" className="block text-small-responsive font-medium text-gray-700 mb-1">Nome</label>
                  <Input type="text" id="name" placeholder="Seu nome completo" className="bg-gray-100 focus:bg-white" />
                </div>
                <div>
                  <label htmlFor="email" className="block text-small-responsive font-medium text-gray-700 mb-1">Email</label>
                  <Input type="email" id="email" placeholder="seu@email.com" className="bg-gray-100 focus:bg-white" />
                </div>
                <div>
                  <label htmlFor="message" className="block text-small-responsive font-medium text-gray-700 mb-1">Mensagem</label>
                  <Textarea id="message" placeholder="Escreva sua mensagem aqui..." rows={6} className="bg-gray-100 focus:bg-white" />
                </div>
                <Button type="submit" className="w-full bg-orange-500 hover:bg-orange-600 text-white font-bold btn-responsive">
                  Enviar Mensagem
                </Button>
              </form>
            </div>
